...
def graph_attribute_builder(nodes1, attribute1, nodes2, attribute2, edges):
    ...
    ##### Create graph from these lists
    #create a sub graph of just playlist and track edges 

    # adding nodes
    Gsub = nx.Graph() #create empty graph 
    Gsub.add_nodes_from([

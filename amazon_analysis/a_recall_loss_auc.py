...
def load_model_runs(model_name, neg, num_runs=5):
    runs = []
    for i in range(num_runs):
        filename = f"LGCN_{model_name}_3_e64_nodes18869__run{i}_{neg}_1e-8_BPR_random_.pkl"
...
def to_numpy(data): #moves tensor to the CPU to make it array
